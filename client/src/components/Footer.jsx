        ...
        <div className="md:max-w-96">
           <img src={assets.logo} alt="logo"  className='h-9'/>
            <p className="mt-6 text-sm">
                Experience the power of AI with Revilo.ai <br/> Transform your content creation with our suite of premium AI tools. Write articles, generate images, and enhance your workflow.
            </p>
        </div>
        <div className="flex-1 flex items-start md:justify-end gap-20">
            ...
            <div>
                ...
                <div className="text-sm space-y-2">
                    ...
                    <div classNameName="flex items-center gap-2 pt-4">
